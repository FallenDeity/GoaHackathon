...
export function ContactForm(): React.JSX.Element {
	...
	return (
		<section className="my-10 px-4 sm:px-16">
			<ToastContainer />
			<motion.div
				initial="hidden"
				whileInView="show"
				...
				className="bg-black-100 flex-[0.75] rounded-2xl p-2 sm:p-8">
				<p className="ml-1 text-[14px] uppercase tracking-wider sm:text-[18px]">Get in touch</p>
				<h3 className="text-[30px] xs:text-[40px] sm:text-[50px] md:text-[60px]">Contact</h3>
				<div className="mt-10 w-full text-center" id="Feedback">
					<div className="mx-auto grid max-w-screen-xl grid-cols-1 gap-8 rounded-lg bg-gray-200 px-8 py-16 text-gray-900 dark:bg-gray-900 dark:text-gray-200 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32">
						<div className="flex flex-col justify-between">
							<div>
								<h2 className="text-2xl font-bold leading-tight sm:text-4xl lg:text-5xl">
									Lets talk about everything!
								</h2>
								<div className="mt-8 text-gray-800 dark:text-gray-700">
									Hate forms? Send an{" "}
								...
								<svg
									...
									<defs>
										...
										<pattern
											...
											width="36.88">
											<rect fill="none" height="49.48" width="36.88" />
									...
									<g opacity="0.1">
										<ellipse cx="479.42" cy="362.12" fill="#3f3d56" rx="11.38" ry="14.9" />
										<path
										...
										/>
										<ellipse cx="479.42" cy="271.07" fill="#3f3d56" rx="11.38" ry="14.9" />
										<ellipse cx="479.42" cy="252.86" fill="#3f3d56" rx="11.38" ry="14.9" />
										<path
									...
									<g opacity="0.1">
										<ellipse cx="612.28" cy="330.26" fill="#3f3d56" rx="8.51" ry="11.13" />
										<path
											...
											transform="translate(-52 -162.63)"
										/>
										<ellipse cx="612.28" cy="262.22" fill="#3f3d56" rx="8.51" ry="11.13" />
										<ellipse cx="612.28" cy="248.61" fill="#3f3d56" rx="8.51" ry="11.13" />
										<path
									...
									<g opacity="0.1">
										<ellipse cx="1038.58" cy="322.12" fill="#3f3d56" rx="11.38" ry="14.9" />
										<path
											...
											transform="translate(-52 -162.63)"
										/>
										<ellipse cx="1038.58" cy="231.07" fill="#3f3d56" rx="11.38" ry="14.9" />
										<ellipse cx="1038.58" cy="212.86" fill="#3f3d56" rx="11.38" ry="14.9" />
										<path
									...
									<g opacity="0.1">
										<ellipse cx="928.72" cy="324.26" fill="#3f3d56" rx="8.51" ry="11.13" />
										<path
											...
											transform="translate(-52 -162.63)"
										/>
										<ellipse cx="928.72" cy="256.22" fill="#3f3d56" rx="8.51" ry="11.13" />
										<ellipse cx="928.72" cy="242.61" fill="#3f3d56" rx="8.51" ry="11.13" />
										<path
									...
									<g opacity="0.1">
										<ellipse cx="61.59" cy="322.12" fill="#3f3d56" rx="11.38" ry="14.9" />
										<path
											...
											transform="translate(-52 -162.63)"
										/>
										<ellipse cx="61.59" cy="231.07" fill="#3f3d56" rx="11.38" ry="14.9" />
										<ellipse cx="61.59" cy="212.86" fill="#3f3d56" rx="11.38" ry="14.9" />
										<path
									...
									<g opacity="0.1">
										<ellipse cx="171.44" cy="324.26" fill="#3f3d56" rx="8.51" ry="11.13" />
										<path
											...
											transform="translate(-52 -162.63)"
										/>
										<ellipse cx="171.44" cy="256.22" fill="#3f3d56" rx="8.51" ry="11.13" />
										<ellipse cx="171.44" cy="242.61" fill="#3f3d56" rx="8.51" ry="11.13" />
										<path
									...
									<ellipse cx="548" cy="493.13" fill="#667eea" opacity="0.1" rx="548" ry="8.86" />
									<ellipse cx="548" cy="565.88" fill="#667eea" opacity="0.1" rx="548" ry="8.86" />
									<ellipse cx="548" cy="341.3" fill="#667eea" opacity="0.1" rx="548" ry="8.86" />
									<ellipse cx="548" cy="417.21" fill="#667eea" opacity="0.1" rx="548" ry="8.86" />
									<path
									...
									<path
										...
										transform="translate(-52 -162.63)"
									/>
									<circle cx="779.73" cy="238.18" fill="#3f3d56" r="99.96" />
									<path
									...
									<path
										...
										transform="translate(-52 -162.63)"
									/>
									<circle cx="550.08" cy="390.01" fill="#3f3d56" r="99.96" />
									<path
									...
									<path
										...
										transform="translate(-52 -162.63)"
									/>
									<circle cx="312.85" cy="315.36" fill="#3f3d56" r="99.96" />
									<path
									...
									<path
										...
										transform="translate(-52 -162.63)"
									/>
									<circle cx="776.11" cy="438.7" fill="#be6f72" r="9.04" />
									<path
									...
									<path
										...
										transform="translate(-52 -162.63)"
									/>
									<circle cx="758.03" cy="419.83" fill="#be6f72" r="8.84" />
									<path
									...
									<path
										...
										transform="translate(-52 -162.63)"
									/>
									<ellipse cx="450.2" cy="429.57" fill="#2f2e41" rx="2.84" ry="2.86" />
									<path
									...
									<path
										...
										transform="translate(-52 -162.63)"
									/>
									<ellipse cx="451.95" cy="431.55" fill="#e8e8f0" rx="2.19" ry="2.2" />
									<path
									...
									<path
										...
										transform="translate(-52 -162.63)"
									/>
									<ellipse cx="450.2" cy="420.35" fill="#fbbebe" rx="8.52" ry="8.57" />
									<path
						...
						<form ref={formRef} onSubmit={handleSubmit}>
							<div>
								<div className="text-sm font-bold uppercase text-gray-900 dark:text-gray-600">
									Email
								</div>
								<label
									className="mb-2 ml-2 mt-4 block text-sm font-semibold text-gray-800"
									htmlFor="email">
									<input
										className="focus:shadow-outline w-full rounded-lg bg-gray-300 p-3 focus:outline-none dark:bg-gray-700 dark:text-gray-300"
										id="email"
										name="email"
										value={form.email}
							...
							<div className="mt-8">
								<span className="text-sm font-bold uppercase text-gray-900 dark:text-gray-600">
									Name
								</span>
								<label
									className="mb-2 ml-2 mt-4 block text-sm font-semibold text-gray-800"
							...
							<div className="mt-8">
								...
								<label
									className="mb-2 ml-2 mt-4 block text-sm font-light text-gray-800"
									htmlFor="message">
									<textarea
										className="focus:shadow-outline w-full rounded-lg bg-gray-300 p-3 focus:outline-none dark:bg-gray-700 dark:text-gray-300"
										id="message"
							...
							<div className="mt-8 p-2">
								<button
									disabled={loading}
									type="submit"
									className="focus:shadow-outline w-full rounded-lg bg-indigo-500 p-3 text-sm font-bold uppercase tracking-wide text-gray-100 shadow-md shadow-blue-500/50 focus:outline-none disabled:cursor-not-allowed disabled:bg-opacity-20"
									id="submit">
									<i className="fas fa-paper-plane pr-3" />
									{loading ? <BeatLoader size={8} color="#ffffff" /> : "Send Message"}
								</button>
							</div>
						</form>
					</div>
...
export default StarWrapper(ContactForm, "Contact");
